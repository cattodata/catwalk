...
export const CULTURAL_EVENTS: CulturalEvent[] = [
  ...
  },
  {
    ...
    cuisineHint: 'Asian',
    predictedLift: 16,
    historicBasis: 'Buddhist community gathering · 18% Asian-cuisine spike',
    ownerAction: 'Vegan Buddhist menu · Thai/Vietnamese options',
  },
  {
    id: 'eid-2026',
    emoji: '🌙',
    ...
    cuisineHint: 'Asian',
    predictedLift: 19,
    historicBasis: '+19% Halal-tagged walks (Lakemba pilot transfer)',
    ownerAction: 'Halal signage · iftar dinner special',
  },
  {
    id: 'christmas-2026',
    emoji: '🎄',
